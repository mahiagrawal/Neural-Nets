...
class ThreeLayerConvNet(object):
  ...
  def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
    ...
    ############################################################################
    C, H, W = input_dim
    pad = (filter_size - 1)/2 # from loss below
    stride = 1
    ...
    stride = 2
    HH = 1 + (H1 - 2)/stride # pool_height = 2
    WW = 1 + (W1 - 2)/stride # pool_width = 2
  ...
  def loss(self, X, y=None):
    ...
    # variable.                                                                #
    ############################################################################
    out1, cache_conv = conv_relu_pool_forward(X, W1, b1, conv_param, pool_param)

    out2, cache_affine = affine_relu_forward(out1, W2, b2)
    ...
    dout, grads['W2'], grads['b2'] = affine_relu_backward(dout, cache_affine)
